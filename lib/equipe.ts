...
export const MEMBRES: Membre[] = [
  ...
  },
  {
    ...
    nom: "Karczewski",
    role: "Co-fondateur",
    bio: "Il vient de la finance, où rien ne se décide sans avoir vérifié le chiffre. Chez Omega, c'est lui qui fait les audits, installe les moteurs et décroche quand vous appelez.",
...
export const EQUIPE_CHAPO =
  "Omega n'est pas une agence à étages. La personne qui fait votre audit est celle qui installe vos moteurs, et celle que vous avez au téléphone six mois plus tard.";
