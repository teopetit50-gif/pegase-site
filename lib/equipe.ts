...
export const MEMBRES: Membre[] = [
  {
    ...
    prenom: "Teo",
    role: "Fondateur",
    bio: "[À COMPLÉTER — deux lignes : ton parcours, et ce qui t'a fait monter Pegase. Les fiches d'hyperstack font 200 à 300 signes, ton ton peut être plus direct.]",
...
export const EQUIPE_CHAPO =
  "Pegase est un desk, pas une agence à étages : la personne qui fait l'audit est celle qui installe le moteur et celle que vous avez au téléphone six mois plus tard.";
