  ...
  familles: [
    {
      ...
      lignes: [
        ...
        { t: "La balance âgée range l'encours par tranche d'ancienneté, compte par compte.", atteste: true },
    ...
    },
    {
      ...
      icone: "megaphone",
      lignes: [
        { t: "Une facture échue suit quatre paliers, du rappel courtois à la mise en demeure.", atteste: true },
        { t: "Un devis sans réponse est relancé dès le troisième jour, puis au septième.", atteste: true },
        { t: "Le ton se durcit à mesure que le montant et l'ancienneté augmentent.", atteste: true },
        { t: "Le système distingue le bon payeur du récidiviste et ajuste le texte.", atteste: true },
        { t: "Une relance part par courriel, par messagerie instantanée ou par courrier.", atteste: true },
        { t: "Vous fixez le canal compte par compte, et le système s'y tient.", atteste: true },
        { t: "Les factures échues d'un même compte tiennent dans une seule relance.", atteste: true },
    ...
    },
    {
      ...
      lignes: [
        ...
        { t: "L'historique de paiement de chaque compte pèse sur le ton des relances.", atteste: true },
        { t: "Un compte qui se dégrade est signalé avant que le retard s'installe.", atteste: false },
        { t: "Les comptes sensibles sortent du périmètre automatique et n'y reviennent que sur décision.", atteste: true },
    ...
    },
    {
      ...
      icone: "chart",
      lignes: [
        { t: "Le délai moyen de règlement se mesure compte par compte.", atteste: true },
        { t: "La prévision d'encaissement est établie à trente et à soixante jours.", atteste: false },
        { t: "Les relances parties, leur canal et leur objet se retrouvent dans un journal.", atteste: true },
