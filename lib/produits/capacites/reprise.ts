  ...
  familles: [
    {
      ...
      lignes: [
        ...
        { t: "Chaque compte est classé par valeur cumulée et par date de dernier achat.", atteste: true },
    ...
    },
    {
      ...
      icone: "megaphone",
      lignes: [
        { t: "Chaque message reprend la date, la référence et le montant du dernier achat.", atteste: true },
        { t: "Vous relisez la première vague compte par compte avant qu'elle parte.", atteste: true },
        { t: "Les règles de ton et de contenu s'écrivent en français, sans case à cocher.", atteste: true },
        { t: "La cadence est plafonnée à une sollicitation par compte et par trimestre.", atteste: true },
        { t: "Une réponse, même négative, arrête la séquence et vous rend la conversation.", atteste: true },
        { t: "Un compte qui a refusé entre en quarantaine pour la durée que vous fixez.", atteste: false },
        { t: "Le canal suit le contact connu : messagerie d'abord, WhatsApp si le numéro existe.", atteste: true },
        { t: "Les vagues s'enchaînent au rythme convenu, et leurs retours sont mesurés.", atteste: true },
      ],
    },
    {
      ...
      icone: "landmark",
      lignes: [
        { t: "Le bulletin officiel français est relevé chaque nuit, avant votre arrivée.", atteste: true },
        ...
        { t: "La recherche s'élargit aux intitulés voisins, parce que l'acheteur n'emploie pas vos mots.", atteste: true },
    ...
    },
    {
      ...
      lignes: [
        ...
        { t: "Une demande d'arrêt vaut retrait immédiat, sur tous les canaux à la fois.", atteste: true },
