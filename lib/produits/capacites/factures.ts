  ...
  familles: [
    {
      ...
      icone: "inbox",
      lignes: [
        { t: "Une adresse dédiée reçoit les pièces, et chaque expéditeur connu est reconnu.", atteste: true },
        { t: "Les PDF natifs, les scans, les photos et les captures d'écran sont lus de la même façon.", atteste: true },
        { t: "Le montant écrit dans le corps d'un message est extrait, même sans pièce jointe.", atteste: true },
    ...
    },
    {
      ...
      lignes: [
        ...
        { t: "Les coordonnées bancaires, le mode et les conditions de règlement.", atteste: true },
    ...
    },
    {
      ...
      icone: "shield",
      lignes: [
        { t: "Le HT, la TVA et le TTC sont recoupés ligne à ligne, puis au pied de la facture.", atteste: true },
        ...
        { t: "Un fournisseur inconnu est mis en attente : sa fiche est proposée, jamais créée seule.", atteste: true },
    ...
    },
    {
      ...
      lignes: [
        ...
        { t: "L'export part vers votre outil comptable, au format qu'il attend.", atteste: true },
        { t: "Le dossier de clôture est transmis complet, à la date convenue avec la comptabilité.", atteste: true },
