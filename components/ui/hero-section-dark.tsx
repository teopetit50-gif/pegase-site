    ...
    <div className={cn("hsd", className)} ref={ref} {...props}>
      ...
      <div className="hsd-dedans r-wrap py-20 sm:py-28">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="text-balance font-[family-name:var(--font-jakarta)] text-[32px] font-medium leading-[1.12] tracking-[-0.01em] text-[#050505] min-[480px]:text-[40px] sm:text-5xl">
